...
# Public API
from fxtrade.interface.bitflyer import Market, Board, BoardState, Ticker, Execution, CorporateLeverage, Chat
...
# Private API
from fxtrade.interface.bitflyer import Permissions, TradingCommission, Balance, BalanceHistory
...
def private_api_example():
    ...
    # 取引手数料
    commission = TradingCommission.get(api_key=api_key, api_secret=api_secret, product_code='BTC_JPY')
    # pprint(commission)
