...
class Typed:
    ...
    def __init__(self, value, type_=None, *, f=None, optional=False, copy=False):
        self._type = type_
        self._f = f
...
class Immutable(Typed):
    def __init__(self, value, type_=None, *, f=None, optional=False, copy=False):
        super().__init__(value, type_, f=f, optional=optional, copy=copy)
...
def typed(value, type_=None, *, f=None, optional=False, copy=False):
    return Typed(value, type_, f=f, optional=optional, copy=copy)

def immutable(value, type_=None, *, f=None, optional=False, copy=False):
    return Immutable(value, type_, f=f, optional=optional, copy=copy)

def protected(value, type_=None, *, f=None, optional=False, copy=False):
    return Protected(value, type_, f=f, optional=optional, copy=copy)

class SafeAttrABC(ABC):
    @staticmethod
    def typed(x, type_=None, *, f=None, optional=False, copy=False):
        return Typed(x, type_, f=f, optional=optional, copy=copy)
    
    @staticmethod
    def immutable(x, type_=None, *, f=None, optional=False, copy=False):
        return Immutable(x, type_, f=f, optional=optional, copy=copy)

    @staticmethod
    def protected(x, type_=None, *, f=None, optional=False, copy=False):
        return Protected(x, type_, f=f, optional=optional, copy=copy)
